...
class WC_azpay_XML extends SimpleXMLElement {
	 ...
	 * Add account data.
	 *
	 * @param string $number Azpay account number.
	 * @param string $key    Azpay account key.
	 */
	...
	public function add_card_data( $card_number, $card_expiry, $card_cvv, $holder_name ) {
		...
		// For more information see page 11 of Manual Desenvovedor de Webservice Azpay v. 2.54.
