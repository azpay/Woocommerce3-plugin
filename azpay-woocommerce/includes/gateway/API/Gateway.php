    ...
    class Gateway
    {
        ...
        public function Authorize(Transaction $transaction)
        {
            ...
            if (strncasecmp(PHP_OS, 'WIN', 3) == 0) {
                file_put_contents("D:\\xampp7\\htdocs\\minhabolsa\\gateway.log", date('Y-m-d H:i - ') . print_r($authorize->toJSON(), true) . PHP_EOL, FILE_APPEND);
            } else {
                file_put_contents("/home/homolog/webapps/homolog-gateway/gateway.log", date('Y-m-d H:i - ') . print_r($authorize->toJSON(), true) . PHP_EOL, FILE_APPEND);
            }
        ...
        public function Sale(Transaction $transaction)
        {
            ...
            if (strncasecmp(PHP_OS, 'WIN', 3) == 0) {
                file_put_contents("D:\\xampp7\\htdocs\\minhabolsa\\gateway.log", date('Y-m-d H:i - ') . print_r($transaction->toJSON(), true) . PHP_EOL, FILE_APPEND);
            } else {
                file_put_contents("/home/homolog/webapps/homolog-gateway/gateway.log", date('Y-m-d H:i - ') . print_r($transaction->toJSON(), true) . PHP_EOL, FILE_APPEND);
            }
