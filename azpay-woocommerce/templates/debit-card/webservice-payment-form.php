...
<fieldset id="azpay-debit-payment-form" class="azpay-payment-form">
	...
	<p class="form-row form-row-last">
		...
		<input id="azpay-card-cvv" name="azpay_debit_cvv" class="input-text wc-credit-card-form-card-cvv" type="tel" autocomplete="off" placeholder="<?php _e( 'CVV', 'azpay-woocommerce' ); ?>" style="font-size: 1.5em; padding: 8px;" />
	</p>	
	<?php if ( 0 < $discount ) : ?>		
